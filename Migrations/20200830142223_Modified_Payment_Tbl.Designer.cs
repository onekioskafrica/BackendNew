...
namespace OK_OnBoarding.Migrations
{
    ...
    [Migration("20200830142223_Modified_Payment_Tbl")]
    partial class Modified_Payment_Tbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.Cart", b =>
                {
                    ...
                    b.HasIndex("CustomerId", "SessionId", "Status", "Mobile", "Email", "CreatedAt");
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.Error", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("SessionId", "Status", "SubTotal", "Tax", "Shipping", "Total", "Promo", "Discount", "GrandTotal", "FirstName", "LastName", "Mobile", "Email", "City", "State", "CreatedAt");
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.ProductPricingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("OldSaleEndDate")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("OldSalePrice")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<DateTime?>("OldSaleStartDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("StoreOwnerId", "ProductId", "DateOfAction");

                    b.ToTable("ProductPricingHistories");
                });
