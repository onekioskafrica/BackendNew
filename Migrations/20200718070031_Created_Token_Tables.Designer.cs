...
namespace OK_OnBoarding.Migrations
{
    ...
    [Migration("20200718070031_Created_Token_Tables")]
    partial class Created_Token_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("Name", "Brand", "InStock", "Model", "TypeId");
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.Store", b =>
                {
                    ...
                    b.HasIndex("StoreId", "FirstName", "LastName", "PhoneNumber", "StoreName", "EmailAddress", "ReferredBy", "IsOneKioskContractAccepted", "DateCreated", "IsActivated");
            ...
            modelBuilder.Entity("OK_OnBoarding.Entities.Product", b =>
                {
                    ...
                    b.HasOne("OK_OnBoarding.Entities.ProductType", "ProductType")
                        .WithMany()
