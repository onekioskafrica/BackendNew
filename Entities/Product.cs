...
namespace OK_OnBoarding.Entities
{
    public class Product
    {
        ...
        public bool InStock { get; set; } //The number of available unit in stock
        ...
        public ProductType ProductType { get; set; } // The ProductType that describes this product
        public ICollection<ProductCategory> ProductCategories { get; set; } // All the Categories of the Product
        public ICollection<ProductImage> ProducutImages { get; set; } // the Product Images of this Product
